...
| bg_cozy_room | background | placeholder | src/assets/backgrounds/ | public/assets/backgrounds/bg_cozy_room.svg | project-original-placeholder | Codex generated placeholder | Stage 2 reward / GameCanvas / Gallery | Replace with final 1920x1080 background before release. |
| bg_neon_room | background | review | src/assets/backgrounds/bg_neon_room.png | public/assets/backgrounds/bg_neon_room.webp | user-provided | User-provided image | Stage 3 reward / GameCanvas / Gallery / NeonBackground | WebP runtime asset added. Confirm final rights/license before release. |
