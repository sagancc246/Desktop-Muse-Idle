...
export function NativeWallpaperStatus({
  ...
  const diagnostics = useMemo<Array<[string, unknown]>>(
    () => [
      ...
      ['Control minimize action', nativeWallpaperStatus.controlViewMinimizeAction],
      ['Recoverable via taskbar', nativeWallpaperStatus.controlViewRecoverableViaTaskbar],
      ['Recoverable via Alt+Tab', nativeWallpaperStatus.controlViewRecoverableViaAltTab],
      ['Restore shortcut', nativeWallpaperStatus.controlViewRestoreShortcut],
      ['Restore available', nativeWallpaperStatus.controlViewRestoreAvailable],
      ['Hidden or minimized', nativeWallpaperStatus.controlViewHiddenOrMinimized],
      ['Restore last result', nativeWallpaperStatus.controlViewRestoreLastResult],
      ...
      ['Control drag region', nativeWallpaperStatus.nativeWallpaperControlWindowDragRegion],
      ['Wide drag enabled', nativeWallpaperStatus.nativeWallpaperControlWindowWideDragRegionEnabled],
      ['No-drag controls', nativeWallpaperStatus.nativeWallpaperControlWindowNoDragControlsApplied],
      ...
      ['Top-level desktop WorkerW', nativeWallpaperStatus.topLevelDesktopWorkerWFound],
      ['Progman child desktop WorkerW', nativeWallpaperStatus.progmanChildDesktopWorkerWFound],
      ['Progman child probe active', nativeWallpaperStatus.progmanChildWorkerWProbeActive],
      ['WorkerW warning level', nativeWallpaperStatus.workerWWarningLevel],
      ['WorkerW warning message', nativeWallpaperStatus.workerWWarningMessage],
      ['Promotion candidate', nativeWallpaperStatus.canPromoteNativeWallpaperToAttachedCandidate],
      ['Promotion blocked', nativeWallpaperStatus.attachedPromotionBlockedReasons?.join(', ')],
      ['Promotion checklist', nativeWallpaperStatus.attachedPromotionChecklist],
      ['Explorer restart detected', nativeWallpaperStatus.explorerRestartDetected],
      ['Stale after Explorer restart', nativeWallpaperStatus.nativeWallpaperStaleAfterExplorerRestart],
      ['Cleanup on exit attempted', nativeWallpaperStatus.nativeWallpaperCleanupOnExitAttempted],
      ['Cleanup on exit succeeded', nativeWallpaperStatus.nativeWallpaperCleanupOnExitSucceeded],
      ['Control closed on exit', nativeWallpaperStatus.nativeWallpaperControlWindowClosedOnExit],
      ['Host closed on exit', nativeWallpaperStatus.nativeWallpaperHostClosedOnExit],
      ['Ghost suspected', nativeWallpaperStatus.nativeWallpaperGhostWindowSuspected],
      ['Win+D expected', nativeWallpaperStatus.winDBehaviorExpected],
      ['Win+D still visible', nativeWallpaperStatus.winDAfterNativeWallpaperStillVisible],
