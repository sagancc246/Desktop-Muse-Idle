...
export const cornerHitAssistZonePx = 32;
export const cornerHitCooldownMs = 600;
export const baseCornerReward = 100;
export const rebootMemoryRequirement = 100_000;
export const museTapDurationMs = 1_800;
export const museTapCooldownMs = 50;
export const museTapDecayStepMs = 260;
export const museTapMaxStacks = 8;
export const museTapSpeedPerStack = 1.12;
export const museTapSpeedMultiplierCap = 2;
